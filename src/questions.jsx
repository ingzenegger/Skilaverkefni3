...
const questions = [
  ...
  {
    id: 7,
    question: "Hvað merkir orðatiltækið að fá sér kríu?",
    options: [
      "Að fá sér gæludýr",
      "Að gogga í hausinn á einhverjum",
      "Að leggja sig",
      "Að stunda leikfimi",
    ],
    correctIndex: 3,
  ...
  {
    id: 8,
    question: "Hvaða fjórir litir eru í merki Google?",
    options: [
      "Gulur, rauður, grænn og blár",
      "Rauður, grænn, blár og fjólublár",
  ...
  {
    id: 9,
    question: "Hvað eru bræðurnir Gísli, Eiríkur og Helgi kallaðir?",
    options: [
      "Skytturnar þrjár",
      "Grísirnir þrír",
      "Hvolpasveit",
